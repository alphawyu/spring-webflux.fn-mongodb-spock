package com.realworld.webfluxfn.support;
...
@Import({LocaleConfigurer.class, ExceptionsFormattingTest.Controller.class, GlobalErrorWebExceptionHandler.class, GlobalErrorAttributes.class})
class ExceptionsFormattingTest {
    ...
    void shouldFormatInvalidRequestException() {
        client.get()
                ...
                .value(s -> assertThat(s).contains("\"message\":\"Username: already in use\""));
    }
